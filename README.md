...
- ✅ **Height Measurement** - Calculate target height using trigonometry
- ✅ **Distance-Height Calculation** - Two methods available
...
- ✅ **Imperial Units** - All measurements in feet and inches
...
### Height Measurement (Two Methods)

**Method 1: Known Distance**
1. Enter your instrument height (default 5.5 ft - eye level)
2. Measure or estimate horizontal distance to target
3. Enter distance in "Horizontal Distance" field
4. Aim at top of target object
5. Press "🎯 Calcular Altura"
6. Result shows:
   - Total target height
   - Height difference from instrument

**Method 2: Two-Station Method (No Distance Needed)**
1. Enter instrument height at Station 1
2. Aim at target, press "🎯 Calcular Altura"
3. App saves Point 1
4. Move to Station 2 (GPS tracks distance)
5. Aim at same target, press "🎯 Calcular Altura" again
6. App calculates height using triangulation

**Example Use Cases:**
- Measure building height from ground
- Check tree height
- Verify construction elevation
- Measure cliff or wall height
- Set grading heights
...
- **Zenith**: 0° to 180°
- **Height**: Calculated using trigonometry
- **Units**: Imperial (feet, inches) throughout
...
CSV file includes:
```csv
#,Timestamp,Mode,Hz (°),V (°),Z (°),Lat,Lon,Alt (ft),Acc (ft),Inst Height (ft),Horiz Dist (ft),Target Height (ft),Height Diff (ft)
1,2024-02-04 15:30:45,horizontal,45.3456,12.5678,77.4322,26.123456,-80.234567,50.2,14.8,5.5,100.0,85.3,79.8
```
